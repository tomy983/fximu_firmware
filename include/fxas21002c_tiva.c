...
void I2CGyroSend(uint32_t ui32WorkerAddress, uint8_t ui32WorkerRegister, uint8_t *pReceiveData, uint8_t ui8NumBytes) {
    ...
    for(ui8Counter = 0; ui8Counter <= (ui8NumBytes - 2); ui8Counter++) {
        ...
        I2CMasterDataPut(I2C2_BASE, pReceiveData[ui8Counter]);
    ...
    // put next piece of data into I2C FIFO
    I2CMasterDataPut(I2C2_BASE, pReceiveData[ui8NumBytes - 1]);
